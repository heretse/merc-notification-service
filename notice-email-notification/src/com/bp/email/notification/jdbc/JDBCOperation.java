...
package com.bp.email.notification.jdbc;
...
public class JDBCOperation
{
    ...
    /**
     * @Title: getRemarkByMac
     * @Description: TODO(根据mac查詢remark)
     * @param @param mac
     * @param @return device name
     * @return String 返回类型
     * @throws
     */
    public static String getRemarkByMac(String mac)
    {
        String deviceName = "";
        Connection conn = getConn();
        String sql = "SELECT remark FROM terminal WHERE mac = '" + mac + "'";
        PreparedStatement pstmt = null;
        try
        {
            pstmt = conn.prepareStatement(sql);
            ...
            while (rs.next())
            {
            	deviceName = rs.getString("remark");
            }
            return deviceName;
        }
        catch (SQLException e)
     ...
     * @Description: TODO(根据id查詢template)
     * @param @param id
     * @return List<Map<String,Object>> 返回类型
     * @throws
     */
    public static List<Map<String, Object>> getTemplateById(int id)
    {
        Connection conn = getConn();
     ...
     * @Description: TODO(根据id查詢attachment)
     * @param @param id
     * @return List<Map<String,Object>> 返回类型
     * @throws
     */
    public static List<Map<String, Object>> getAttachmentById(int id)
    {
        Connection conn = getConn();
        String sql = "select * from attachment_data_relation rr left join attachment_data a on rr.attachId = a.id where templateId =  " + id ;
        PreparedStatement pstmt = null;
        try
        {
            pstmt = conn.prepareStatement(sql);
     ...
     * @Description: TODO(定时器定时查询数据库是否有未推送邮件的数据)
     * @param @return 设定文件
     * @return List<Map<String,Object>> 返回类型
     * @throws
     */
